...
public class test {
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/recruit?useSSL=false&serverTimezone=UTC");
        dataSource.setUsername("root");
        dataSource.setPassword("pz020525");
        ...
        globalConfig.setAuthor("彭政");    //设置作者
        ...
        packageInfo.setParent("com.pzz");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
